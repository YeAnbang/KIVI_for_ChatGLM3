...
class CoreAttention(torch.nn.Module):
    ...
    def forward(self, query_layer, key_layer, value_layer, attention_mask):
        ...
        if 1:
            ...
            # print("before calculating matmul", torch.cuda.memory_allocated(0)/ 1024 / 1024)
            ...
            # print("after calculating matmul", torch.cuda.memory_allocated(0)/ 1024 / 1024)
            ...
            # print("after softmax", torch.cuda.memory_allocated(0)/ 1024 / 1024)
            ...
            # print("after attention output", torch.cuda.memory_allocated(0)/ 1024 / 1024)
    ...
    def forward(
        ...
        if use_cache:
            if kv_cache is None:
                ...
                print("key_layer", key_layer.element_size() * key_layer.nelement()/ 1024 / 1024)
                print("value_layer", value_layer.element_size() * value_layer.nelement()/ 1024 / 1024)
                print(kv_cache.element_size() * kv_cache.nelement()/ 1024 / 1024)
                print(key_layer.size(), value_layer.size(), kv_cache.size())
                print(key_layer.dtype, value_layer.dtype, kv_cache.dtype)
            else:
        ...
        if isinstance(kv_cache, torch.Tensor):
            print("prefill", torch.cuda.max_memory_allocated(device=torch.device("cuda"))/ 1024 / 1024)
